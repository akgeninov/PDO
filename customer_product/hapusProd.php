                    ...
                    <div class="tabelHasil">
                        ...
                        <tbody>
                            <?php
                                ...
                                $no = 1;
                                while($prod = $tampil->fetch(PDO::FETCH_ASSOC)):
                            ?>
                                    <tr>
                                        <td><?php echo $no; ?></td>
                                        ...
                                        <td>
                                                <a href='hapusProd.php?kode=<?php echo $prod['productCode']; ?>'>
                                                    hapus
                                                </a>
                                            </td>
                                    </tr>
                        ...
                        <?php
                          if(isset($_GET['kode'])){
                            $hapus = "DELETE FROM products WHERE productCode = '$_GET[kode]'";
                            $hapus_prod = $kon->prepare($hapus);
                            $hapus_prod->execute();
                            echo "<meta http-equiv='refresh' URL='hapusProd.php'";
                        }
                        ?>
                    </div>
                </main>
